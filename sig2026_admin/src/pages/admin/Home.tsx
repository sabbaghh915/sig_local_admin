...
export default function Home() {
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-gradient-to-br from-indigo-600 via-purple-600 to-fuchsia-600 p-6">
          ...
          <Card className="border-white/30 bg-white/90 backdrop-blur shadow-2xl hover:shadow-[0_20px_60px_rgba(0,0,0,0.25)] transition">
            <CardContent className="p-8">
              <div className="flex flex-col items-center text-center space-y-4">
                <div className="bg-gradient-to-r from-indigo-600 to-fuchsia-600 p-4 rounded-2xl shadow-md">
